...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Seo\Manifest;
...
class ManifestCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.seo.manifest.manifest-card', ['urls' => $this->urls]);
    }}
