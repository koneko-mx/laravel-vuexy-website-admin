...
use Koneko\VuexyWebsiteAdmin\Application\UIX\ConfigBuilders\Blog\TagsTableConfigBuilder;

class BlogTagsTable extends AbstractTableComponent
{
    /**
    ...
    {
        return TagsTableConfigBuilder::class;
    }
