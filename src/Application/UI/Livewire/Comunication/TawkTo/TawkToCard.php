...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Comunication\TawkTo;
...
class TawkToCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.comunication.tawk-to.tawk-to-card');
    }
}
