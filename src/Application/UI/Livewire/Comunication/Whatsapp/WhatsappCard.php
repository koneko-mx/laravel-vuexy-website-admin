...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Comunication\Whatsapp;
...
class WhatsappCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.comunication.whatsapp.whatsapp-card');
    }
}
