...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Comunication\Twitter;
...
class TwitterCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.comunication.twitter.twitter-card');
    }
}
