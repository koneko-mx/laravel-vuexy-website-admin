...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Comunication\Messenger;
...
class MessengerCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.comunication.messenger.messenger-card');
    }
}
