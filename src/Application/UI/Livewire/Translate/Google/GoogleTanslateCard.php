...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Translate\Google;
...
class GoogleTanslateCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.translate.google.google-translate-card');
    }
}
