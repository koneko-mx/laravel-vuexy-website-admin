...
class WebsiteFaviconCard extends Component
{
    use WithFileUploads;

    private $targetNotify = "#website-favicon-card-card .notification-container";
    ...
    {
        return view('vuexy-website-admin::livewire.settings.general.website-favicon-card');
    }
}
