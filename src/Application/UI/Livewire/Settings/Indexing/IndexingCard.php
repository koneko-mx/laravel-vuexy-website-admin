...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Settings\Indexing;

use Koneko\VuexyAdmin\Application\Settings\SettingsService;
use Koneko\VuexyAdmin\Application\System\SettingsService as SystemSettingsService;
use Koneko\VuexyWebsiteAdmin\Application\Services\WebsiteTemplateService;
use Livewire\Component;

class IndexingCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.settings.indexing.indexing-card');
    }
}
