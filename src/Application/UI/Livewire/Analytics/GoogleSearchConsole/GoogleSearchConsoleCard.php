...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Analytics\GoogleSearchConsole;
...
class GoogleSearchConsoleCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.analytics.google-search-console.google-search-console-card');
    }
}
