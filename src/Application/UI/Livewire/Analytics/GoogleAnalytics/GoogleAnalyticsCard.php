...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Analytics\GoogleAnalytics;
...
class GoogleAnalyticsCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.analytics.google-analytics.google-analytics-card');
    }
}
