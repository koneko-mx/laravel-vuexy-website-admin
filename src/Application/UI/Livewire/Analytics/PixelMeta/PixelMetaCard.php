...
namespace Koneko\VuexyWebsiteAdmin\Application\UI\Livewire\Analytics\PixelMeta;
...
class PixelMetaCard extends Component
{
    ...
    {
        return view('vuexy-website-admin::livewire.analytics.pixel-meta.pixel-meta-card');
    }
}
